    ...
    return (
        <div>
            ...
            <h4>
                ...
                <Button variant="contained" color="primary">Select Offer 1</Button>
            ...
            <Button variant = "contained" color = "primary">Select Offer 2</Button>
            ...
            <h4>1 Masszymes
                ...
                <Button variant="contained" color="primary">Select Offer 3</Button>
                <div>
                <Button
                    variant="contained"
                    color="secondary"
